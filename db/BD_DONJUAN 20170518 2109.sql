...
-- Script date 05/18/2017 9:09:25 PM
...
GO
INSERT dbo.CATEGORIA(NOMBRE, CATEGORIA_ID) VALUES (N'Brochas', 1)
GO
...
--
-- Table BD_DONJUAN.dbo.CLIENTE does not contain any data (it is empty)
-- 
-- Dumping data for table COMPRA
--
SET IDENTITY_INSERT dbo.COMPRA ON
GO
INSERT dbo.COMPRA(COMPRA_ID, PROVEEDOR_ID, SUBTOTAL, TOTAL, ESTADO, FECHA, FACTURA) VALUES (1, 1, 500.0000, 1200.0000, N'Aprobado', '2017-05-18', NULL)
INSERT dbo.COMPRA(COMPRA_ID, PROVEEDOR_ID, SUBTOTAL, TOTAL, ESTADO, FECHA, FACTURA) VALUES (2, 1, 100.0000, 120.0000, NULL, '2017-05-18', N'FACT')
GO
...
--
-- Table BD_DONJUAN.dbo.EMPLEADO does not contain any data (it is empty)
-- 
-- Dumping data for table FACTURACION
--
-- Table BD_DONJUAN.dbo.FACTURACION does not contain any data (it is empty)
-- 
-- Dumping data for table INVENTARIO
--
SET IDENTITY_INSERT dbo.INVENTARIO ON
GO
INSERT dbo.INVENTARIO(INVENTARIO_ID, PRODUCTO_ID, CANTIDAD) VALUES (1, 1, 26)
GO
...
--
-- Table BD_DONJUAN.dbo.PEDIDO does not contain any data (it is empty)
-- 
...
GO
INSERT dbo.PRODUCTO(PRODUCTO_ID, CATEGORIA_ID, PROVEEDOR_ID, NOMBRE, PRECIO, COSTO, UNIDAD, MARCA) VALUES (1, 1, 1, N'Brochas', 24.0000, 200.0000, N'Piezas', N'Stylish')
GO
...
GO
INSERT dbo.PRODUCTO_MOVIMIENTO(PRODUCTO_MOVIMIENTO_ID, PRODUCTO_ID, PROVEEDOR_ID, COMPRA_ID, PEDIDO_ID, CANTIDAD, TIPO) VALUES (1, 1, NULL, 1, NULL, 4, N'Compra')
INSERT dbo.PRODUCTO_MOVIMIENTO(PRODUCTO_MOVIMIENTO_ID, PRODUCTO_ID, PROVEEDOR_ID, COMPRA_ID, PEDIDO_ID, CANTIDAD, TIPO) VALUES (2, 1, NULL, 2, NULL, 2, N'Compra')
GO
...
GO
INSERT dbo.PROVEEDOR(PROVEEDOR_ID, NOMBRE, DIRECCION, TELEFONO, RFC, EMAIL) VALUES (1, N'Mary Kay', N'Calle Dolores', N'6628547856', N'MARYKAY8547', N'soporte@marykay.com')
GO
...
--
-- Table BD_DONJUAN.dbo.PUESTO does not contain any data (it is empty)
-- 
...
--
-- Table BD_DONJUAN.dbo.VENTA does not contain any data (it is empty)
-- 
-- Dumping data for table VENTA_PRODUCTO
--
-- Table BD_DONJUAN.dbo.VENTA_PRODUCTO does not contain any data (it is empty)
